...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            audio_waveform::local_audio_waveform,
            ...
            library::library_pack_mirror_stats,
            library::library_set_pack_listable_total,
            library::library_record_pack_ranks,
            library::library_pack_popularity_scores,
            library::library_official_popularity_status,
            library::library_restart_official_popularity,
            library::library_checkpoint_official_popularity,
            library::library_finish_official_popularity,
